  ...
  return (
    <div className="min-h-screen bg-beige inconsolata">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <StepIndicator currentStep={5} steps={INDICATOR_STEPS} />
        ...
        <div className="bg-white rounded-3xl shadow-lg p-5 sm:p-8 md:p-10 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto mb-6 sm:mb-8">
            {[
              { id: 'yes' as const, label: 'Ja', helper: 'Diagnose liegt bereits vor' },
              { id: 'no' as const, label: 'Nein', helper: 'Noch keine ärztliche Diagnose' },
            ].map((option) => {
          ...
          <p className="text-xs sm:text-sm text-red-500 max-w-xl mx-auto mb-8">
            Falls du bisher keine Diagnose erhalten hast, kannst du kein Rezept von uns erhalten und musst erst einen
            Arzt aufsuchen.
          </p>
