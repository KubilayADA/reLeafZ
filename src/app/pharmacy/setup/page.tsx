...
function SetupForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${API_BASE}/api/pharmacy/accept-invite`, {
        method: 'POST',
    ...
    <div className="px-6 py-6">
      {done ? (
        <div className="text-center py-4">
          ...
          <p className="text-sm text-gray-500 mb-6">Your password has been set. You can now log in to your pharmacy dashboard.</p>
          <button
    ...
    <div className={`${dmSans.className} min-h-screen bg-gray-50 flex items-center justify-center px-4`}>
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">Pharmacy Account Setup</p>
        </div>
