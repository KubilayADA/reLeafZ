  ...
  return (
    <article className="partner-apotheken-story">
      ...
      <header className="partner-apotheken-story-header">
        <h3 className="partner-apotheken-story-title">
          {pharmacy.name}
          <span className="partner-apotheken-coming-soon-pill">Coming soon</span>
        </h3>
      </header>
      ...
      <div className="partner-apotheken-story-points">
        ...
        <p>
          <span className="partner-apotheken-story-term">Versand</span>
          {' — '}
          Sicher und diskret per DHL in 1–3 Werktagen, deutschlandweit.
        </p>
      </div>
